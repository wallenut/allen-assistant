...
const EXTRACTION_PROMPT = `Extract a list of atomic facts, decisions, preferences, and open questions from this conversation. Return ONLY a JSON array of objects with shape {"type": "fact"|"decision"|"preference"|"question", "content": string, "source": "user"|"assistant"}. Set "source" to "user" if the fact was explicitly stated or confirmed by the User, "assistant" if it was generated by the Assistant from its own knowledge. No markdown, no explanation.`
